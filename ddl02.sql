...
무결정(Integrity) : 데이터가 올바르게! 일관되게! 유지!
...
VALUES (2, SYSDATE);  --name이 NOT NULL이라서 불가
...
CREATE TABLE tt02
(
    no NUMBER(3) CONSTRAINT tt02_no_uk UNIQUE,
...
INSERT INTO tt02
VALUES ( 2, 'name2', SYSDATE, 60, 'Q'); --pass 가능범위 제약 ('Y','N')
